/**
 * auth.js — Authentication handler for Ellucian Banner Student
 * Supports: SSO (CAS / Shibboleth / Duo), MFA (Duo Security)
 *
...
const BASE_URL = process.env.ELLUCIAN_BANNER_URL || 'https://your-university.edu/ssomanager/c/SSB';
const USERNAME = process.env.ELLUCIAN_BANNER_USERNAME;
const PASSWORD = process.env.ELLUCIAN_BANNER_PASSWORD;
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set ELLUCIAN_BANNER_USERNAME and ELLUCIAN_BANNER_PASSWORD in .env`);
  }

  console.log('Logging in to Ellucian Banner Student...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });

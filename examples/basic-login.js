/**
 * basic-login.js — Basic login example for Ellucian Banner Student
...
async function main() {
  ...
  try {
    log('Starting Ellucian Banner Student automation (Open Source mode)');
    ...
    const result = await login_banner(page, {
    ...
    // const data = await register_student(page, {});
    // log('Data:', data);
